...
if(isset($_POST['entrar']))
{
	...
	$login_2007 = "sygescol2007/login_rv.php";   //para el 2007
	$login_2008 = "sygescol2008/login_rv.php";   //para el 2008
	$login_2009 = "sygescol2009/login_rv.php";   //para el 2009
	$login_2010 = "sygescol2010/login_rv.php";   //para el 2010
	$login_2011 = "sygescol2011/login_rv.php";   //para el 2011
	$login_2012 = "sygescol2012/login_rv.php";   //para el 2011
	$login_2013 = "sygescol2013/login_rv.php";   //para el 2011
	if($_POST['anoLectivo'] > 2012){
		$action = "sygescol".$_POST['anoLectivo']."/login_rv.php";
	}else{
