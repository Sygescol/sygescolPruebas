...
if(isset($_POST['entrar']))
{
	...
	$login_2007 = "sygescol2007/acu_generardocu_acu_generardocu_login.php";   //para el 2007
	$login_2008 = "sygescol2008/acu_generardocu_acu_generardocu_login.php";   //para el 2008
	$login_2009 = "sygescol2009/acu_generardocu_acu_generardocu_login.php";   //para el 2009
	$login_2010 = "sygescol2010/acu_generardocu_acu_generardocu_login.php";   //para el 2010
	$login_2011 = "sygescol2011/acu_generardocu_acu_generardocu_login.php";   //para el 2011
	$login_2012 = "sygescol2012/acu_generardocu_login.php";   //para el 2011
	$login_2013 = "sygescol2013/acu_generardocu_login.php";   //para el 2011
	if($_POST['anoLectivo'] > 2012){
		$action = "sygescol".$_POST['anoLectivo']."/acu_generardocu_login.php";
	}else{
...
<body onLoad="enviarFormulario()">
	<form action="<?php echo $action; ?>" method="get" name="datosAcceso" id="datosAcceso">
	<input type="hidden" name="documento_acudiente" id="documento_acudiente" value="<?php echo $_POST['documento_acudiente']; ?>" />
	</form>
</body>
</html>
<?php
